  ...
  <div v-if="visibleDialog">
    ...
    >
      <el-form label-width="80px" size="mini">
        <el-form-item label="小组名称" style="width: 550px">
          <el-input
            v-model="groupName"
            placeholder="小组名称"
            maxlength="30"
...
export default {
  ...
  methods: {
    ...
    confirm() {
      ...
      this.groupSave(this.groupName, this.selecteds);
    },
    groupSave(groupName, users) {
      ...
      this.$api.basics
        ...
        .then((res) => {
          const result = res.result;
          this.saveUser(result.id, users);
        });
    },
    saveUser(groupId, users) {
      this.$api.basics
        .sysgroupUserSet({
          groupId: groupId,
          userList: users
