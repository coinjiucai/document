<template>
  <div class="component-testQuestionList full-block flex-layout">
    <el-form :inline="true">
      <el-form-item label="题型" style="margin-bottom: 0">
        <el-select
          disabled
          placeholder="题型"
      ...
      <el-form-item label="题目" style="margin-bottom: 0">
        <el-input
      ...
      <el-form-item label="难度" style="margin-bottom: 0">
        <el-select v-model="pageInfo.difficulty" placeholder="难度" size="mini">
          <el-option
...
export default {
  ...
  methods: {
    isAdd(v) {
      const item = this.questionBankList.find((item) => item.id == v.id);
