<template>
  <div class="psychologicalResource" id="psychologicalResource"></div>
</template>

<script>
import 'echarts-gl'; // 引入 echarts-gl
export default {
  name: 'psychologicalResource',
  components: {},
  data() {
    return {
      option: {},
  ...
  methods: {
    init() {
      ...
      let myChart = new this.$echarts.init(
        document.getElementById('psychologicalResource')
      );
      // 传入数据生成 option
    ...
    bindListen(myChart) {
      ...
      myChart.on('click', (params) => {
        if (params.name === '心理量表') {
          this.$router.push({
            path: '/psychologicalScale'
          });
        } else if (params.name == '心理资讯') {
          this.$router.push({
            path: '/consult'
          });
        } else if (params.name == '心理游戏') {
          this.$router.push({
            path: '/sourceManage/game'
          });
        } else if (params.name == '心理课程') {
          this.$router.push({
            path: '/sourceMange/course'
          });
        } else if (params.name == '心理漫画') {
          this.$router.push({
            path: '/sourceMange/comics'
          });
        }
      });
