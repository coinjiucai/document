...
<template>
  ...
  >
    <div
      ...
      class="flex-auto flex-layout overflow-hidden"
      style="height: inherit"
    >
      <div class="flex-auto better-scroll flex-layout pa10">
        所拥有的权限：
        <BaseTree
          v-if="visibleDrawer"
          ref="baseTree"
        ...
        >
          <template v-slot:edit="{ node, data }">
            <div v-if="data['ruleFlag']" @click.stop="">
              <Transition name="permission-option">
                <el-dropdown v-if="node['isCurrent']">
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item
                      @click.native="batchCheckButtons('all', node)"
                      >全选</el-dropdown-item
                    >
                    <el-dropdown-item
              ...
              <Transition name="list-permission" v-if="data['ruleFlag'] === 1">
                <el-radio-group
                  :key="data['value']"
                  class="ml5"
                  v-if="node['checked']"
                  ...
                  size="small"
                >
                  <el-radio-button :label="LIST_PERMISSION.PERSON"
                    >本人</el-radio-button
                  >
